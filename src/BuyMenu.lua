...
local Button1 = {
    ...
    stages = {
        ...
        { text = "+ 5 SOLS per [CLICK]",    price = 200,    effect = 5 },
        { text = "+ 15 SOLS per [CLICK]",   price = 1000,   effect = 15 },
        { text = "+ 25 SOLS per [CLICK]",   price = 2000,   effect = 25 }
    },
...
local Button2 = {
    ...
    stages = {
        ...
        { text = "+10 SOLS/s",  price = 600,    effect = 10 },
        { text = "+20 SOLS/s",  price = 1200,   effect = 20 },
        { text = "+40 SOLS/s",  price = 2400,   effect = 40 }
    },
...
function BuyMenu.draw()
    ...
    for i, button in ipairs(buttons) do
        ...
        if button.isHovered then
            ...
            love.graphics.printf(stage.text, sW / 2 - 150, sH / 2 - menuFont:getHeight() / 2 - 80, 300, "center")
            menuFont = love.graphics.newFont("Fonts/PerfectDOSVGA437.ttf", 20)
            love.graphics.setFont(menuFont)
            love.graphics.printf("SOLS Required: " .. stage.price, sW / 2 - 150, sH / 2 - menuFont:getHeight() / 2 - 50, 300, "center")
        end
